...
public class PostController {
	...
	public void updateCommunity() {
		...
		// 서비스에게 이전 커뮤니티명과 이후 커뮤니티명을 주고 커뮤니티명을 수정하라고 요창한 후 성공하면
		// 커뮤니티 수정 성공!을 출력
	...
	public void printPostList(Criteria cri) {
		...
		// 가져온 게시글 리스트의 길이가 0이면 등록된 게시글이 없습니다.라고 출력하고 종료
		if(list.size() == 0) {
	...
	public void insertComment(PostVO post, String id) {
		// post null이면 댓글을 추가할 수 없습니다.를 출력하고 종룔
		if(post == null) {
