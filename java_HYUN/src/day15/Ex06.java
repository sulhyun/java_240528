...
public class Ex06 {
	...
	public static void main(String[] args) {
		...
		List<Integer> com = CreatRandom(min, max, count);
	...
	private static List<Integer> CreatRandom(int min, int max, int count) {
		...
		// 숫자 야구 게임에서 순서가 중요하기 때문에 Set 에 있는 숫자들을 List 에 저장한 후 섞어 줌
