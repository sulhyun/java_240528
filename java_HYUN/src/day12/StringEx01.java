...
public class StringEx01 {
	...
	public static void main(String[] args) {
		...
		// boolean equals(Object object) : 문자열이 같이지를 반환
		...
		// String replace(찾을 문자열, 교체할 문자열) : 문자열에서 찾을 문자열을 찾차서 교체할 문자열로 바꾼 후 반환
