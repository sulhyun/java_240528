...
public class AccountBook implements Serializable {
	...
	private static final long serialVersionUID = 8075965484808160432L;
	
	private List<Item> list = new ArrayList<Item>();
	// Arrays.asList : 배열을 바로 리스트로 사용하기 위해 사용
