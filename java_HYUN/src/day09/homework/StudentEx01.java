		...
		do {
			...
			case 2:
				...
				for (Student student : list) {
				    if (student != null && student.getGrade() == grade && student.getClassNum() == classNum && student.getNum() == num) {
						index = i;
						break;
					}
				    i++;
			...
			case 3:
				...
				// 있다면 해당 학생의 성적을 출력
			        ...
			        System.out.println("성적 확인 - " + list[index].getName() + " 학생");
			        System.out.println("국어 성적 : " + list[index].getKor());
			        System.out.println("영어 성적 : " + list[index].getEng());
			        System.out.println("수학 성적 : " + list[index].getMath());
			    }
				break;
			case 4:
