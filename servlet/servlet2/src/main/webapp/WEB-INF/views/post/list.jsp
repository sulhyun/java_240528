...
<title>${co.co_name}커뮤니티 게시글 목록</title>
</head>
<body>
...
<div class="container" style="min-height: calc(100vh - 240px)">
				...
				<tr>
					...
					<td>
						<c:url value="/post/list" var="url">
							<c:param name="type" value="writer"></c:param>
							<c:param name="search" value="${post.po_me_id}"></c:param>
							<c:param name="co_num" value="${pm.cri.co_num}"></c:param>
						</c:url>
	...
	<div class="clearfix">
		<a class="btn btn-outline-success float-right" href="<c:url value="/post/insert?co_num=${co.co_num}"/>" style="margin-bottom : 30px;">게시글 등록</a>	
	</div>
</div>
