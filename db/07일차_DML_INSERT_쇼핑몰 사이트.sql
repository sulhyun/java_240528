...
# abc123회원이 로그인 시도가 성공했을 때 싱행해야하는 쿼리
UPDATE MEMBER SET ME_FAIL = 0 WHERE ME_ID = 'abc123';

# abc123회원이 비번 찾기를 시도해서 인증코드가 123asd가 발급됐을 때 실행되야하는 쿼리
INSERT INTO CODE VALUES
('abc123', '123asd', DATE_ADD(NOW(), INTERVAL 5 MINUTE));
