...
INSERT INTO MOVIE_COUNTRY VALUE (NULL, '미국', 1);
...
(NULL, '액션', 1), (NULL, '코미디', 1); 

# 6. 영화인을 등록 : 데드풀과 울버린의 나오는 모든 영화인
INSERT INTO PERSON VALUE
(NULL, '숀 레비', '1968-07-28', '', '캐나다');
INSERT INTO PERSON VALUES
(NULL, '라이언 레이놀즈', '1976-10-23', '<엑스맨 탄생: 울버린> 등의 액션 블록버스터와 호러, 로맨틱 무비 등...', '캐나다'),
...
# 데드풀과 울버린 영황 상영시간을 등록
# CGV 강남 - 7/27
# 1관 - 10:00(조조), 12:35, 15:10, 17:45, 20:20
# 2관 - 10:30(조조), 15:00, 20:00, 23:00
# 3관 - 09:00(조조), 11:30, 14:10, 16:45, 19:20
INSERT INTO SCHEDULE VALUES
(NULL, '10:00', '2024-07-27', 1, 1, 1),(NULL, '12:35', '2024-07-27', 0, 1, 1),
(NULL, '15:10', '2024-07-27', 0, 1, 1),(NULL, '17:45', '2024-07-27', 0, 1, 1),
(NULL, '20:20', '2024-07-27', 0, 1, 1),
(NULL, '10:30', '2024-07-27', 1, 1, 2),(NULL, '15:00', '2024-07-27', 0, 1, 2),
(NULL, '20:00', '2024-07-27', 0, 1, 2),(NULL, '23:00', '2024-07-27', 0, 1, 2),
(NULL, '09:00', '2024-07-27', 1, 1, 3),(NULL, '11:30', '2024-07-27', 0, 1, 3),
(NULL, '14:10', '2024-07-27', 0, 1, 3),(NULL, '16:45', '2024-07-27', 0, 1, 3),
...
# 4관 - 16:00
INSERT INTO SCHEDULE VALUES
(NULL, '08:00', '2024-07-27', 1, 1, 4),(NULL, '10:40', '2024-07-27', 0, 1, 4),
(NULL, '16:00', '2024-07-27', 0, 1, 4),(NULL, '18:40', '2024-07-27', 0, 1, 4),
(NULL, '09:40', '2024-07-27', 1, 1, 5),(NULL, '15:00', '2024-07-27', 0, 1, 5),
(NULL, '23:00', '2024-07-27', 0, 1, 5),
(NULL, '08:40', '2024-07-27', 1, 1, 6),(NULL, '17:00', '2024-07-27', 0, 1, 6),
(NULL, '16:00', '2024-07-27', 0, 1, 7);

# 성인 : 14000원, 청소년 : 10000원, 조조 성인 : 12000원, 조조 청소년 : 8000원 등록하는 쿼리
INSERT INTO PRICE VALUES
(NULL, '성인', 14000),(NULL, '청소년', 10000),
(NULL, '조조 성인', 12000),(NULL, '조조 청소년', 8000);
