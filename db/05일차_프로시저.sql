...
USE CGV;
# 예약자 아이디, 예매 사영시간 번호, 성인수, 청소년수가 주어지면 티켓을 예매하는 프로시저를 생성하고 테스트
...
BEGIN
	...
	END CASE;
    INSERT INTO TICKETING VALUES(NULL, _ADULT, _TEENAGER, _ADULT_PRICE + _TEENAGER_PRICE, _ID, _SD_NUM);
END//
DELIMITER ;
